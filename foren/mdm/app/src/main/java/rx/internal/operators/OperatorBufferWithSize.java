            ...
            return new Producer() { // from class: rx.internal.operators.OperatorBufferWithSize.BufferExact.1
                ...
                public void request(long n) {
                    if (n < 0) {
                        ...
                        BufferExact.this.request(BackpressureUtils.multiplyCap(n, BufferExact.this.count));
                    }
                }
            };
        }
            ...
            public void request(long n) {
                if (n < 0) {
                    ...
                    if (get() || !compareAndSet(false, true)) {
                        ...
                        parent.request(BackpressureUtils.addCap(BackpressureUtils.multiplyCap(n, parent.count), BackpressureUtils.multiplyCap(parent.skip - parent.count, n - 1)));
                    }
                }
            }
        }
        ...
        public final class BufferOverlapProducer extends AtomicBoolean implements Producer {
            ...
            public void request(long n) {
                ...
                if (BackpressureUtils.postCompleteRequest(parent.requested, n, parent.queue, parent.actual) && n != 0) {
                    if (get() || !compareAndSet(false, true)) {
                        parent.request(BackpressureUtils.multiplyCap(parent.skip, n));
                    } else {
                        parent.request(BackpressureUtils.addCap(BackpressureUtils.multiplyCap(parent.skip, n - 1), parent.count));
                    }
                }
            }
        }
