...
public final class Util {
    ...
    private static final Charset UTF_16_BE = Charset.forName(Charsets.UTF_16BE);
    private static final Charset UTF_16_LE = Charset.forName(Charsets.UTF_16LE);
    ...
    private static String inet6AddressToAscii(byte[] address) {
        ...
        while (i2 < address.length) {
            if (i2 == longestRunOffset) {
                ...
                result.writeHexadecimalUnsignedLong(((address[i2] & 255) << 8) | (address[i2 + 1] & 255));
                i2 += 2;
            }
        }
