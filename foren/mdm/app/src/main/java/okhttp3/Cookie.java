...
public final class Cookie {
    ...
    static Cookie parse(long currentTimeMillis, HttpUrl url, String setCookie) {
        ...
        while (pos < limit) {
            ...
            } else if (attributeName.equalsIgnoreCase(ClientCookie.MAX_AGE_ATTR)) {
                try {
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = (((((((((((((((this.name.hashCode() + 527) * 31) + this.value.hashCode()) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + ((int) (this.expiresAt ^ (this.expiresAt >>> 32)))) * 31) + (this.secure ? 0 : 1)) * 31) + (this.httpOnly ? 0 : 1)) * 31) + (this.persistent ? 0 : 1)) * 31;
        if (!this.hostOnly) {
            i = 1;
        }
        return hashCode + i;
