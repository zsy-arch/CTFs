...
public final class p {
    ...
    static {
        ...
        L_0x0046:
            r5[r3] = r2
            cn.jpush.android.service.p.z = r6
            return
        L_0x004b:
            r11 = 99
            goto L_0x0021
    ...
    public static String a(Context context, String str) {
        try {
            ...
            return (String) loadClass.getMethod(z[1], String.class).invoke(loadClass, new String(str));
    ...
    public static String a(Context context, String str, String str2) {
        try {
            Class<?> loadClass = context.getClassLoader().loadClass(z[0]);
            return (String) loadClass.getMethod(z[1], String.class, String.class).invoke(loadClass, new String(str), new String(str2));
        } catch (IllegalArgumentException e) {
            throw e;
        } catch (Exception e2) {
            return str2;
