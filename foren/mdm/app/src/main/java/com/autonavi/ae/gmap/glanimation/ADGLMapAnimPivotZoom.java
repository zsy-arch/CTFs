...
public class ADGLMapAnimPivotZoom extends ADGLAnimation {
    ...
    public void commitAnimation(Object obj) {
        ...
        if (gLMapState != null) {
            ...
            if (Math.abs(this._mapLevelTo - mapZoomer) < 1.0E-6d) {
                this._isOver = true;
        ...
        if (gLMapState != null) {
            ...
            if (!this._isOver) {
                ...
                if (f3 >= 0.0f && f3 <= 1.0f) {
                    ...
                    if (!this._zoomCenter) {
                        float pow = (float) Math.pow(2.0d, f2 - this._zoomParam.getFromValue());
                        gLMapState.setMapGeoCenter(((int) ((this._pivotGeoX - this._beginCenterGeoX) * (1.0f - (1.0f / pow)))) + this._beginCenterGeoX, ((int) ((1.0f - (1.0f / pow)) * (this._pivotGeoY - this._beginCenterGeoY))) + this._beginCenterGeoY);
                    }
