...
public class WTBT {
    ...
    public native WMileageInfo getMileageInfo();
    ...
    public native WPoint[] getRouteHawkEyePoints();
    ...
    public native int init(IFrameForWTBT iFrameForWTBT, String str, String str2, String str3, String str4, String str5);
