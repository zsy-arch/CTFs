...
public class NeedsSearchEndActivity extends BaseActivity implements NavGroup.OnCheckedChangeListener, XRefreshViewListener, DemandMainRecycleAdapter.AdapterItemClick, DemandBrushDialog.BrushType {
    ...
    private void getDemandOrService(int orderBy, int serviceMode) {
        ...
        getClient().get(R.string.API_DEMAND_HOMEPAGE, argument + "?pageNo=" + this.page + "&pageSize=30&lat=" + this.latitude + "&lng=" + this.longitude + "&orderBy=" + orderBy + "&serviceMode=" + serviceMode + "&keyWord=" + this.keyWord, params, DemandServiceBean.class);
    }
