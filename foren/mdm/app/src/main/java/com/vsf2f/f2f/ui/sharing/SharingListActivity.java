...
public class SharingListActivity extends BaseActivity implements XRefreshViewListener {
    ...
    public void initView() {
        initHeaderBack(R.string.records_transaction_plat, R.drawable.icon_help_white);
    ...
    class SharingListAdapter extends BaseAdapter<SharingRecordBean> {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (recordBean.getType() == 1) {
                h.txt3.setText(" 收购 ");
                h.txt4.setTextColor(SharingListActivity.this.getResources().getColor(R.color.txt_red_finace));
                h.txt4.setText(Marker.ANY_NON_NULL_MARKER + recordBean.getTradeNum());
            } else if (recordBean.getType() == 3) {
                h.txt3.setText(" 出让 ");
                h.txt4.setTextColor(SharingListActivity.this.getResources().getColor(R.color.holo_green_light));
