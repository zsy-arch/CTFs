...
public class LevelUnderBean implements Parcelable {
    public static final Parcelable.Creator<LevelUnderBean> CREATOR = new Parcelable.Creator<LevelUnderBean>() { // from class: com.vsf2f.f2f.bean.LevelUnderBean.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public LevelUnderBean createFromParcel(Parcel in) {
            return new LevelUnderBean(in);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public LevelUnderBean[] newArray(int size) {
            return new LevelUnderBean[size];
        }
    };
    ...
    protected LevelUnderBean(Parcel in) {
