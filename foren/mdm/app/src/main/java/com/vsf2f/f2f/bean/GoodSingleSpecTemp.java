...
public class GoodSingleSpecTemp {
    ...
    public String toString() {
        return "GoodSingleSpecTemp{specGuid='" + this.specGuid + "', specName='" + this.specName + "', specValue='" + this.specValue + "', specValueGuid='" + this.specValueGuid + "'}";
    }
}
