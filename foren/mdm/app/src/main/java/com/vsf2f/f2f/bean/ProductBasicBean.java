...
public class ProductBasicBean implements Parcelable {
    public static final Parcelable.Creator<ProductBasicBean> CREATOR = new Parcelable.Creator<ProductBasicBean>() { // from class: com.vsf2f.f2f.bean.ProductBasicBean.1
        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ProductBasicBean createFromParcel(Parcel source) {
            return new ProductBasicBean(source);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public ProductBasicBean[] newArray(int size) {
            return new ProductBasicBean[size];
        }
    };
    ...
    public static class GoodsPictureBean implements Parcelable {
        public static final Parcelable.Creator<GoodsPictureBean> CREATOR = new Parcelable.Creator<GoodsPictureBean>() { // from class: com.vsf2f.f2f.bean.ProductBasicBean.GoodsPictureBean.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
    ...
    protected ProductBasicBean(Parcel in) {
        this.id = in.readInt();
