...
public class MyMoneyGiveActivity extends BaseActivity {
    private EditText etMoney;
    private EditText etRemark;

    @Override // com.hy.frame.common.IBaseActivity
    public int initLayoutId() {
        return R.layout.act_my_money_give;
    }
    ...
    public void initView() {
        ...
        this.etMoney = (EditText) getView(R.id.mycoins_etGiveCoins);
        this.etMoney.addTextChangedListener(new TextWatcher() { // from class: com.vsf2f.f2f.ui.user.MyMoneyGiveActivity.1
