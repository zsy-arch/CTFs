...
public class ShopDescriptionDialog extends Dialog {
    private NearbyShopBean.RowsBean bean;
    private View.OnClickListener clickListener;
    private Context context;
    Handler handler = new Handler() { // from class: com.vsf2f.f2f.ui.dialog.ShopDescriptionDialog.1
        @Override // android.os.Handler
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if (msg != null && msg.obj != null) {
                ShopDescriptionDialog.this.riv_user.setImageBitmap((Bitmap) msg.obj);
            }
        }
    };
    ...
    public ShopDescriptionDialog(Context context, View.OnClickListener clickListener) {
    ...
    public void setData(NearbyShopBean.RowsBean bean) {
        this.bean = bean;
    }

    public NearbyShopBean.RowsBean getData() {
        return this.bean;
    }
    ...
    public void getBitmap() {
        ...
        try {
            bitmap = null;
            try {
                bitmap = Glide.with(this.context).load(this.bean.getLogo().getSpath()).asBitmap().into(Integer.MIN_VALUE, Integer.MIN_VALUE).get();
                if (bitmap == null) {
    ...
    protected void onStart() {
        super.onStart();
        ThreadPool.newThreadPool(new Runnable() { // from class: com.vsf2f.f2f.ui.dialog.ShopDescriptionDialog.2
            @Override // java.lang.Runnable
            public void run() {
                ShopDescriptionDialog.this.getBitmap();
            }
        });
        String distance = LocationUtils.getDistance(this.bean.getLat(), this.bean.getLng());
        this.tv_name.setText(this.bean.getUserName());
        this.tv_price.setText("拥有产品：" + this.bean.getGoodsCount());
        this.tv_content.setText("在售产品：" + this.bean.getSalesCount());
        this.tv_title.setText(this.bean.getStoreName());
