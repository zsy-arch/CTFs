...
public class ShareForwardCodeDialog extends BaseDialog {
    public ShareForwardCodeDialog(Context context) {
        super(context);
    }

    @Override // com.hy.frame.common.BaseDialog
    protected int initLayoutId() {
        return R.layout.dlg_share_forward_code;
    }
    ...
    protected void initView() {
        setOnClickListener(R.id.txt_save);
