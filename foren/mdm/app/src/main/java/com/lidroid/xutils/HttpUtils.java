...
public class HttpUtils {
    ...
    public HttpUtils(int connTimeout, String userAgent) {
        ...
        HttpProtocolParams.setUserAgent(params, TextUtils.isEmpty(userAgent) ? OtherUtils.getUserAgent(null) : userAgent);
        ...
        this.httpClient.addRequestInterceptor(new HttpRequestInterceptor() { // from class: com.lidroid.xutils.HttpUtils.1
            ...
            public void process(HttpRequest httpRequest, HttpContext httpContext) throws HttpException, IOException {
                if (!httpRequest.containsHeader("Accept-Encoding")) {
                    httpRequest.addHeader("Accept-Encoding", HttpUtils.ENCODING_GZIP);
                }
            }
        });
    ...
    public ResponseStream sendSync(HttpRequest.HttpMethod method, String url) throws com.lidroid.xutils.exception.HttpException {
        return sendSync(method, url, null);
    }

    public ResponseStream sendSync(HttpRequest.HttpMethod method, String url, RequestParams params) throws com.lidroid.xutils.exception.HttpException {
        if (url != null) {
