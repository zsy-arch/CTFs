...
public class ParseConfig {
    ...
    public static Task<ParseConfig> getAsync(final Task<Void> toAwait) {
        return ParseUser.getCurrentSessionTokenAsync().onSuccessTask(new Continuation<String, Task<ParseConfig>>() { // from class: com.parse.ParseConfig.2
            ...
            public Task<ParseConfig> then(Task<String> task) throws Exception {
                ...
                return toAwait.continueWithTask(new Continuation<Void, Task<ParseConfig>>() { // from class: com.parse.ParseConfig.2.1
                    @Override // bolts.Continuation
                    public Task<ParseConfig> then(Task<Void> task2) throws Exception {
    ...
    public static ParseConfig decode(JSONObject json, ParseDecoder decoder) {
        Map<String, Object> decodedParams = (Map) ((Map) decoder.decode(json)).get("params");
