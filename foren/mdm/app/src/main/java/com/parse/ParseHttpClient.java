...
public abstract class ParseHttpClient<LibraryRequest, LibraryResponse> {
    ...
    public void addInternalInterceptor(ParseNetworkInterceptor interceptor) {
        if (this.hasExecuted) {
    ...
    public void addExternalInterceptor(ParseNetworkInterceptor interceptor) {
