...
public class Data {
    ...
    public static byte[] AES128Decode(byte[] keyBytes, byte[] cipherText) throws Throwable {
        ...
        int ptLength2 = ptLength + cipher.doFinal(plainText, ptLength);
        return plainText;
    }
    ...
    public static String Base64AES(String msg, String key) {
        ...
        try {
            ...
            return (TextUtils.isEmpty(result) || !result.contains("\n")) ? result : result.replace("\n", "");
        } catch (Throwable e) {
    ...
    public static String MD5(String data) {
        byte[] tmp;
        if (data == null || (tmp = rawMD5(data)) == null) {
            return null;
        }
        return toHex(tmp);
    }
    ...
    public static byte[] rawRSADecode(byte[] data, byte[] privateKey, int keySize) throws Throwable {
        ...
        cipher.init(2, (RSAPrivateKey) KeyFactory.getInstance("RSA").generatePrivate(pkeySpec));
    ...
    public static byte[] rawRSAEncode(byte[] data, byte[] publicKey, int keySize) throws Throwable {
        ...
        Cipher cipher = Cipher.getInstance("RSA/None/PKCS1Padding");
        cipher.init(1, (RSAPublicKey) KeyFactory.getInstance("RSA").generatePublic(spec));
    ...
    public static String urlEncode(String s, String enc) throws Throwable {
        ...
        return TextUtils.isEmpty(text) ? text : text.replace(Marker.ANY_NON_NULL_MARKER, "%20");
    }
}
