...
public class Constants {
    ...
    public static final String SDK_QUA = "V1_AND_OpenSDK_3.1.3_1077_RDM_B";
    private static final String SDK_VER = "3.1.3";
    public static final String SDK_VERSION = "3.1.3";
    public static final String SDK_VERSION_REPORT = "OpenSdk_3.1.3";
    public static final String SDK_VERSION_STRING = "Android_SDK_3.1.3";
