...
public class QQShare extends BaseApi {
    ...
    private void a(final Activity activity, final Bundle bundle, final IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(string)) {
            ...
            if (Util.isQQVersionBelow(activity, SystemUtils.QQ_VERSION_NAME_4_3_0)) {
                ...
                f.b("openSDK_LOG.QQShare", "shareToMobileQQ -- QQ Version is > 4.3.0 ");
                a.a(activity, string, new AsynLoadImgBack() { // from class: com.tencent.connect.share.QQShare.2
                    ...
                    public void saved(int i, String str) {
                        if (i == 0) {
                            ...
                            d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, QQShare.this.mToken.getAppId(), String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants.MSG_SHARE_GETIMG_ERROR);
                            return;
                        }
                        QQShare.this.b(activity, bundle, iUiListener);
                    }
    ...
    public void b(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (hasActivityForIntent(intent)) {
            d.a().a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_SHARE_TO_QQ, str, "3", "0", this.mViaShareQQType, "0", "1", "0");
            ...
            d.a().a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_SHARE_TO_QQ, str, "3", "1", this.mViaShareQQType, "0", "1", "0");
