...
public class WebSettings {
    ...
    public static String getDefaultUserAgent(Context context) {
        if (bi.b().c() || Build.VERSION.SDK_INT < 17) {
            return null;
        }
        Object a = v.a((Class<?>) android.webkit.WebSettings.class, "getDefaultUserAgent", (Class<?>[]) new Class[]{Context.class}, context);
    ...
    public synchronized void setPluginState(PluginState pluginState) {
        if (this.c && this.a != null) {
            ...
            v.a(this.b, "setPluginState", new Class[]{WebSettings.PluginState.class}, WebSettings.PluginState.valueOf(pluginState.name()));
        }
    }
    ...
    public synchronized void setPluginsPath(String str) {
        if (this.c && this.a != null) {
            ...
            v.a(this.b, "setPluginsPath", new Class[]{String.class}, str);
        }
    }
    ...
    public synchronized void setTextZoom(int i) {
        if (this.c && this.a != null) {
            ...
            v.a(this.b, "setTextZoom", new Class[]{Integer.TYPE}, Integer.valueOf(i));
        }
    }
