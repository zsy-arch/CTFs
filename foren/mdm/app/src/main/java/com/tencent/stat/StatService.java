...
public class StatService {
    ...
    public static int a(Context context, boolean z) {
        ...
        z2 = z && currentTimeMillis - c >= ((long) StatConfig.getSessionTimoutMillis());
        c = currentTimeMillis;
        if (d == 0) {
            d = k.c();
        }
    ...
    static boolean b(Context context) {
        if (k.b(StatConstants.VERSION) > p.a(context, StatConfig.c, 0L)) {
            return true;
        }
        StatConfig.setEnableStatService(false);
        return false;
    ...
    public static boolean startStatService(Context context, String str, String str2) {
        ...
        } else if (k.b(StatConstants.VERSION) < k.b(str2)) {
