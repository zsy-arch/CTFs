...
public final class a implements SharedPreferences {
    ...
    private final String[] b = {Field.ID, "key", "type", "value"};
    private final HashMap<String, Object> c = new HashMap<>();
    private SharedPreferences$EditorC0081a d = null;

    /* renamed from: com.tencent.mm.sdk.a$a  reason: collision with other inner class name */
    /* loaded from: classes2.dex */
    private static class SharedPreferences$EditorC0081a implements SharedPreferences.Editor {
        private ContentResolver a;
        private Map<String, Object> e = new HashMap();
        private Set<String> f = new HashSet();
        private boolean g = false;

        public SharedPreferences$EditorC0081a(ContentResolver contentResolver) {
    ...
    private Object getValue(String str) {
        try {
            Cursor query = this.a.query(a.b.CONTENT_URI, this.b, "key = ?", new String[]{str}, null);
            if (query == null) {
                return null;
            }
            Object a = query.moveToFirst() ? a.C0085a.a(query.getInt(query.getColumnIndex("type")), query.getString(query.getColumnIndex("value"))) : null;
            query.close();
            return a;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public final SharedPreferences.Editor edit() {
        if (this.d == null) {
            this.d = new SharedPreferences$EditorC0081a(this.a);
        }
        return this.d;
    }
    ...
    public final Map<String, ?> getAll() {
        try {
            Cursor query = this.a.query(a.b.CONTENT_URI, this.b, null, null, null);
            if (query == null) {
                return null;
            }
            ...
            while (query.moveToNext()) {
                this.c.put(query.getString(columnIndex), a.C0085a.a(query.getInt(columnIndex2), query.getString(columnIndex3)));
            }
            query.close();
            return this.c;
        } catch (Exception e) {
