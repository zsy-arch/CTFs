...
public class WebView extends FrameLayout implements View.OnLongClickListener {
    ...
    public static int NIGHT_MODE_ALPHA = ParseException.FILE_DELETE_ERROR;
    ...
    public class a extends android.webkit.WebView {
        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            WebView.this = r4;
            CookieSyncManager.createInstance(r4.i).startSync();
            try {
    ...
    public WebView(Context context, AttributeSet attributeSet, int i, Map<String, Object> map, boolean z) {
        ...
        if (("com.tencent.mobileqq".equals(this.i.getApplicationInfo().packageName) || "com.tencent.mm".equals(this.i.getApplicationInfo().packageName)) && l.a(true).h() && Build.VERSION.SDK_INT >= 11) {
            setLayerType(1, null);
        }
        if (this.l != null) {
    ...
    private boolean a(View view) {
        Object a2;
        if ((this.i == null || getTbsCoreVersion(this.i) <= 36200) && (a2 = v.a(this.x, "onLongClick", new Class[]{View.class}, view)) != null) {
    ...
    */
    private int c(android.content.Context r9) {
        /*
    ...
    public static String getCrashExtraMessage(Context context) {
        ...
        if (QbSdk.k != null && QbSdk.k.containsKey(TbsCoreSettings.TBS_SETTINGS_WEAPP_ID_KEY) && QbSdk.k.containsKey(TbsCoreSettings.TBS_SETTINGS_WEAPP_NAME_KEY)) {
            sb.append("\n");
            sb.append("weapp_id:" + QbSdk.k.get(TbsCoreSettings.TBS_SETTINGS_WEAPP_ID_KEY) + h.b + TbsCoreSettings.TBS_SETTINGS_WEAPP_NAME_KEY + ":" + QbSdk.k.get(TbsCoreSettings.TBS_SETTINGS_WEAPP_NAME_KEY) + h.b);
        }
    ...
    public static synchronized Object getPluginList() {
        ...
        synchronized (WebView.class) {
            a2 = !bi.b().c() ? v.a("android.webkit.WebView", "getPluginList") : null;
        }
        return a2;
    }
    ...
    public static void setWebContentsDebuggingEnabled(boolean z) {
        if (Build.VERSION.SDK_INT >= 19) {
            try {
                o = Class.forName("android.webkit.WebView").getDeclaredMethod("setWebContentsDebuggingEnabled", Boolean.TYPE);
                if (o != null) {
    ...
    public void a(Context context) {
        int c2 = c(context);
        String str = c2 != -1 ? "PV=" + String.valueOf(c2 + 1) : "PV=1";
        File file = new File(context.getDir("tbs", 0) + File.separator + "core_private", "pv.db");
        if (file != null) {
            try {
    ...
    public boolean canZoomIn() {
        ...
        if (Build.VERSION.SDK_INT >= 11 && (a2 = v.a(this.g, "canZoomIn")) != null) {
            return ((Boolean) a2).booleanValue();
        }
        return false;
    }
    ...
    public boolean canZoomOut() {
        ...
        if (Build.VERSION.SDK_INT >= 11 && (a2 = v.a(this.g, "canZoomOut")) != null) {
            return ((Boolean) a2).booleanValue();
        }
        return false;
    }
    ...
    public Picture capturePicture() {
        ...
        Object a2 = v.a(this.g, "capturePicture");
        if (a2 == null) {
            return null;
        }
        return (Picture) a2;
    ...
    public int computeHorizontalScrollExtent() {
        ...
        try {
            if (this.e) {
                ...
                a2.setAccessible(true);
                i = ((Integer) a2.invoke(this.f.getView(), null)).intValue();
            } else {
                Method a3 = v.a(this.g, "computeHorizontalScrollExtent", new Class[0]);
                a3.setAccessible(true);
                i = ((Integer) a3.invoke(this.g, null)).intValue();
            }
            return i;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public int computeHorizontalScrollRange() {
        ...
        try {
            if (this.e) {
                i = ((Integer) v.a(this.f.getView(), "computeHorizontalScrollRange", new Class[0], new Object[0])).intValue();
            } else {
                Method a2 = v.a(this.g, "computeHorizontalScrollRange", new Class[0]);
                a2.setAccessible(true);
                i = ((Integer) a2.invoke(this.g, null)).intValue();
            }
            return i;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public int computeVerticalScrollRange() {
        ...
        try {
            if (this.e) {
                i = ((Integer) v.a(this.f.getView(), "computeVerticalScrollRange", new Class[0], new Object[0])).intValue();
            } else {
    ...
    public int findAll(String str) {
        ...
        Object a2 = v.a(this.g, "findAll", new Class[]{String.class}, str);
        if (a2 == null) {
            return 0;
        }
    ...
    public View findHierarchyView(String str, int i) {
        return !this.e ? (View) v.a(this.g, "findHierarchyView", new Class[]{String.class, Integer.TYPE}, str, Integer.valueOf(i)) : this.f.findHierarchyView(str, i);
    }
    ...
    public int getContentWidth() {
        ...
        Object a2 = v.a(this.g, "getContentWidth");
        if (a2 == null) {
            return 0;
        }
        return ((Integer) a2).intValue();
    ...
    public int getVisibleTitleHeight() {
        ...
        Object a2 = v.a(this.g, "getVisibleTitleHeight");
        if (a2 == null) {
            return 0;
        }
        return ((Integer) a2).intValue();
    ...
    public boolean isPrivateBrowsingEnabled() {
        ...
        if (Build.VERSION.SDK_INT >= 11 && (a2 = v.a(this.g, "isPrivateBrowsingEnabled")) != null) {
            return ((Boolean) a2).booleanValue();
        }
        return false;
    }
    ...
    public boolean onLongClick(View view) {
        if (this.y == null || !this.y.onLongClick(view)) {
            return a(view);
        }
        return true;
    }
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (Build.VERSION.SDK_INT >= 21 && b(this.i) && isHardwareAccelerated() && i > 0 && i2 > 0 && getLayerType() != 2 && this.f != null && this.f.getView() != null) {
    ...
    public boolean restorePicture(Bundle bundle, File file) {
        ...
        Object a2 = v.a(this.g, "restorePicture", new Class[]{Bundle.class, File.class}, bundle, file);
        if (a2 == null) {
            return false;
        }
        return ((Boolean) a2).booleanValue();
    ...
    public boolean savePicture(Bundle bundle, File file) {
        ...
        Object a2 = v.a(this.g, "savePicture", new Class[]{Bundle.class, File.class}, bundle, file);
        if (a2 == null) {
            return false;
        }
        return ((Boolean) a2).booleanValue();
    ...
    public void setFindListener(IX5WebViewBase.FindListener findListener) {
        if (this.e) {
            ...
            this.g.setFindListener(new bd(this, findListener));
        }
    }
    ...
    public void setPictureListener(PictureListener pictureListener) {
        if (!this.e) {
            if (pictureListener == null) {
                ...
                this.g.setPictureListener(new bf(this, pictureListener));
            }
        } else if (pictureListener == null) {
            this.f.setPictureListener(null);
        } else {
            this.f.setPictureListener(new bg(this, pictureListener));
        }
    }
    ...
    public void setWebViewClient(WebViewClient webViewClient) {
        ...
        a aVar = this.g;
        if (webViewClient != null) {
            zVar = new z(this, webViewClient);
        }
        aVar.setWebViewClient(zVar);
    }
    ...
    public boolean super_dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        try {
            Object a2 = v.a(this.f.getView(), "super_dispatchTouchEvent", new Class[]{MotionEvent.class}, motionEvent);
            if (a2 == null) {
                return false;
            }
            return ((Boolean) a2).booleanValue();
    ...
    public boolean super_onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        try {
            Object a2 = v.a(this.f.getView(), "super_onInterceptTouchEvent", new Class[]{MotionEvent.class}, motionEvent);
            if (a2 == null) {
                return false;
            }
            return ((Boolean) a2).booleanValue();
    ...
    public boolean super_onTouchEvent(MotionEvent motionEvent) {
        ...
        try {
            Object a2 = v.a(this.f.getView(), "super_onTouchEvent", new Class[]{MotionEvent.class}, motionEvent);
            if (a2 == null) {
                return false;
            }
            return ((Boolean) a2).booleanValue();
    ...
    public boolean super_overScrollBy(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z) {
        ...
        try {
            Object a2 = v.a(this.f.getView(), "super_overScrollBy", new Class[]{Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Integer.TYPE, Boolean.TYPE}, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), Integer.valueOf(i5), Integer.valueOf(i6), Integer.valueOf(i7), Integer.valueOf(i8), Boolean.valueOf(z));
            if (a2 == null) {
                return false;
            }
            return ((Boolean) a2).booleanValue();
