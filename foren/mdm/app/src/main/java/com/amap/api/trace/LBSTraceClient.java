...
public class LBSTraceClient {
    ...
    private static void a(Context context) {
        if (context != null) {
            try {
                a = (LBSTraceBase) hm.a(context.getApplicationContext(), dt.e(), "com.amap.api.wrapper.LBSTraceClientWrapper", fx.class, new Class[]{Context.class}, new Object[]{context.getApplicationContext()});
            } catch (Throwable th) {
                a = new fx(context.getApplicationContext());
            }
        }
    }
