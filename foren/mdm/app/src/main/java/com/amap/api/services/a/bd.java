...
public class bd {
    ...
    */
    private static java.net.Proxy b(android.content.Context r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.services.a.bd.b(android.content.Context):java.net.Proxy");
    }
    ...
    private static Proxy a(Context context, URI uri) {
        if (c(context)) {
            try {
                ...
                bh.a(th, "ProxyUtil", "getProxySelectorCfg");
            }
        }
        return null;
    }
