    ...
    */
    public void trimToSize(int r7) {
        ...
        L_0x0043:
            ...
            goto L_0x0000
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yolanda.nohttp.tools.LruCache.trimToSize(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        synchronized (this) {
            ...
            format = String.format(Locale.getDefault(), "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(hitPercent));
        }
        return format;
    }
}
