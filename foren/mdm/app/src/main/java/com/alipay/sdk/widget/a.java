...
public final class a {
    ...
    private AlertDialogC0010a f;
    private Activity g;
    private String h;

    /* renamed from: com.alipay.sdk.widget.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
    public class AlertDialogC0010a extends AlertDialog {
        /* JADX INFO: Access modifiers changed from: protected */
        public AlertDialogC0010a(Context context) {
            super(context);
        }
        ...
        protected final void onCreate(Bundle bundle) {
            ...
            layoutParams2.setMargins(a(a.this.g, 17.0f), a(a.this.g, 10.0f), a(a.this.g, 8.0f), a(a.this.g, 10.0f));
