...
public final class Code39Reader extends OneDReader {
    ...
    static final int[] CHARACTER_ENCODINGS = {52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, TbsListener.ErrorCode.THROWABLE_INITTESRUNTIMEENVIRONMENT, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, 193, a.a, 145, 400, 208, 133, 388, 196, 148, 168, 162, 138, 42};
    ...
    public Result decodeRow(int rowNumber, BitArray row, Map<DecodeHintType, ?> hints) throws NotFoundException, ChecksumException, FormatException {
        ...
        if (nextStart == end || whiteSpaceAfterEnd * 2 >= lastPatternSize) {
            ...
            return new Result(resultString, null, new ResultPoint[]{new ResultPoint((start[1] + start[0]) / 2.0f, rowNumber), new ResultPoint(nextStart + (lastPatternSize / 2.0f), rowNumber)}, BarcodeFormat.CODE_39);
        }
        throw NotFoundException.getNotFoundInstance();
    }
