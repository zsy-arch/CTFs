...
final class FieldParser {
    ...
    private static final Object[][] TWO_DIGIT_DATA_LENGTH = {new Object[]{"00", 18}, new Object[]{"01", 14}, new Object[]{"02", 14}, new Object[]{"10", VARIABLE_LENGTH, 20}, new Object[]{"11", 6}, new Object[]{"12", 6}, new Object[]{"13", 6}, new Object[]{"15", 6}, new Object[]{"17", 6}, new Object[]{GuideControl.CHANGE_PLAY_TYPE_LYH, 2}, new Object[]{Constants.VIA_REPORT_TYPE_QQFAVORITES, VARIABLE_LENGTH, 20}, new Object[]{Constants.VIA_REPORT_TYPE_DATALINE, VARIABLE_LENGTH, 29}, new Object[]{"30", VARIABLE_LENGTH, 8}, new Object[]{"37", VARIABLE_LENGTH, 8}, new Object[]{"90", VARIABLE_LENGTH, 30}, new Object[]{"91", VARIABLE_LENGTH, 30}, new Object[]{"92", VARIABLE_LENGTH, 30}, new Object[]{"93", VARIABLE_LENGTH, 30}, new Object[]{"94", VARIABLE_LENGTH, 30}, new Object[]{"95", VARIABLE_LENGTH, 30}, new Object[]{"96", VARIABLE_LENGTH, 30}, new Object[]{"97", VARIABLE_LENGTH, 30}, new Object[]{"98", VARIABLE_LENGTH, 30}, new Object[]{"99", VARIABLE_LENGTH, 30}};
    ...
    public static String parseFieldsInGeneralPurpose(String rawInformation) throws NotFoundException {
        ...
        for (Object[] dataLength2 : objArr2) {
            if (dataLength2[0].equals(firstThreeDigits)) {
                return dataLength2[1] == VARIABLE_LENGTH ? processVariableAI(3, ((Integer) dataLength2[2]).intValue(), rawInformation) : processFixedAI(3, ((Integer) dataLength2[1]).intValue(), rawInformation);
            }
        }
    ...
    private static String processFixedAI(int aiSize, int fieldSize, String rawInformation) throws NotFoundException {
        ...
        String result = String.valueOf('(') + ai + ')' + field;
        String parsedAI = parseFieldsInGeneralPurpose(rawInformation.substring(aiSize + fieldSize));
        return parsedAI == null ? result : String.valueOf(result) + parsedAI;
    }
