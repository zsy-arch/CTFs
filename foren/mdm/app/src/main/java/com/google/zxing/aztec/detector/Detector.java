...
public final class Detector {
    ...
    private void extractParameters(ResultPoint[] bullsEyeCorners) throws NotFoundException {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            if (this.compact) {
                ...
                i = ((side >> 2) & TbsLog.TBSLOG_CODE_SDK_UNAVAIL_X5CORE) + ((side >> 1) & 31);
            }
    ...
    private ResultPoint[] getBullsEyeCorners(Point pCenter) throws NotFoundException {
        ...
        if (this.nbCenterLayers == 5 || this.nbCenterLayers == 7) {
            ...
            return expandSquare(new ResultPoint[]{new ResultPoint(pina.getX() + 0.5f, pina.getY() - 0.5f), new ResultPoint(pinb.getX() + 0.5f, pinb.getY() + 0.5f), new ResultPoint(pinc.getX() - 0.5f, pinc.getY() + 0.5f), new ResultPoint(pind.getX() - 0.5f, pind.getY() - 0.5f)}, (this.nbCenterLayers * 2) - 3, this.nbCenterLayers * 2);
        }
        throw NotFoundException.getNotFoundInstance();
    }
