...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{60, ParseException.INVALID_ROLE_NAME}, "US/CA");
            ...
            add(new int[]{481}, "BY");
            add(new int[]{482}, "UA");
            add(new int[]{484}, f.as);
            add(new int[]{485}, "AM");
            add(new int[]{486}, "GE");
            add(new int[]{487}, "KZ");
            add(new int[]{489}, "HK");
            add(new int[]{490, 499}, "JP");
            add(new int[]{500, TbsListener.ErrorCode.INFO_CODE_FILEREADER_OPENFILEREADER_FILEPATHISNULL}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{603}, "GH");
            add(new int[]{Constant.FLAG_RECEIVE_UPDATE_MSG}, "BH");
            add(new int[]{Constant.FLAG_RECEIVE_FORCE_LOGINOUT}, "MU");
            add(new int[]{611}, "MA");
            add(new int[]{613}, "DZ");
            add(new int[]{616}, "KE");
            add(new int[]{618}, "CI");
            ...
            add(new int[]{628}, "SA");
            add(new int[]{629}, "AE");
            add(new int[]{ImageUtils.SCALE_IMAGE_WIDTH, 649}, "FI");
            ...
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
            add(new int[]{899}, RedPacketConstant.EXTRA_RED_PACKET_ID);
