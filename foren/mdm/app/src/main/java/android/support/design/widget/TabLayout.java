...
public class TabLayout extends HorizontalScrollView {
    ...
    public static final class Tab {
        ...
        public Tab setCustomView(@LayoutRes int resId) {
            return setCustomView(LayoutInflater.from(this.mView.getContext()).inflate(resId, (ViewGroup) this.mView, false));
        }
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context) {
            ...
            if (this$0.mTabBackgroundResId != 0) {
                ViewCompat.setBackground(this, AppCompatResources.getDrawable(context, this$0.mTabBackgroundResId));
            }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            if (tabLayout != null) {
                tabLayout.setScrollPosition(position, positionOffset, this.mScrollState != 2 || this.mPreviousScrollState == 1, (this.mScrollState == 2 && this.mPreviousScrollState == 0) ? false : true);
            }
        }
