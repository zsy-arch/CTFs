...
public class Explode extends Visibility {
    ...
    public Animator onAppear(ViewGroup sceneRoot, View view, TransitionValues startValues, TransitionValues endValues) {
        ...
        return TranslationAnimationCreator.createAnimation(view, endValues, bounds.left, bounds.top, endX + this.mTempLoc[0], endY + this.mTempLoc[1], endX, endY, sDecelerate);
    }
    ...
    private void calculateOut(View sceneRoot, Rect bounds, int[] outVector) {
        ...
        float xVector = bounds.centerX() - focalX;
        float yVector = bounds.centerY() - focalY;
