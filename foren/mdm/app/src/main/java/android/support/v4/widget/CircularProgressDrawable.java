...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float fraction, int startValue, int endValue) {
        ...
        return ((((int) ((((endValue >> 24) & 255) - startA) * fraction)) + startA) << 24) | ((((int) ((((endValue >> 16) & 255) - startR) * fraction)) + startR) << 16) | ((((int) ((((endValue >> 8) & 255) - startG) * fraction)) + startG) << 8) | (((int) (((endValue & 255) - startB) * fraction)) + startB);
    }
