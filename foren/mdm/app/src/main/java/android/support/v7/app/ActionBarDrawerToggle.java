...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    @RequiresApi(11)
    /* loaded from: classes.dex */
    public static class HoneycombDelegate implements Delegate {
    ...
    @RequiresApi(14)
    /* loaded from: classes.dex */
    public static class IcsDelegate extends HoneycombDelegate {
    ...
    @RequiresApi(18)
    /* loaded from: classes.dex */
    public static class JellybeanMr2Delegate implements Delegate {
        final Activity mActivity;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes.dex */
    public static class DummyDelegate implements Delegate {
        final Activity mActivity;
