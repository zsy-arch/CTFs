...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        if (PermissionChecker.checkSelfPermission(this.mContext, "android.permission.ACCESS_FINE_LOCATION") == 0) {
            fineLoc = getLastKnownLocationForProvider(GeocodeSearch.GPS);
        }
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - a.j, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(a.j + now, location.getLatitude(), location.getLongitude());
