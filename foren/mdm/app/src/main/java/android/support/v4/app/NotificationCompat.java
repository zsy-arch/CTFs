...
public class NotificationCompat {
    ...
    @RequiresApi(19)
    /* loaded from: classes.dex */
    public static class NotificationCompatApi19Impl extends NotificationCompatApi16Impl {
    ...
    @RequiresApi(21)
    /* loaded from: classes.dex */
    public static class NotificationCompatApi21Impl extends NotificationCompatApi20Impl {
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            if (this.mBuilder.mContentInfo != null) {
                ...
                if (this.mBuilder.mNumber > res.getInteger(R.integer.status_bar_notification_info_maxnum)) {
                    ...
                    contentView.setTextViewText(R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                contentView.setViewVisibility(R.id.info, 0);
                showLine3 = true;
                hasRightSide = true;
            ...
            if (showLine2 && Build.VERSION.SDK_INT >= 16) {
                if (fitIn1U) {
                    contentView.setTextViewTextSize(R.id.text, 0, res.getDimensionPixelSize(R.dimen.notification_subtext_size));
                }
