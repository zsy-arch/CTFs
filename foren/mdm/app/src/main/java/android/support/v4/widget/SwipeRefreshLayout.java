...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mAnimateToCorrectPosition = new Animation() { // from class: android.support.v4.widget.SwipeRefreshLayout.6
            ...
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((SwipeRefreshLayout.this.mFrom + ((int) ((endTarget - SwipeRefreshLayout.this.mFrom) * interpolatedTime))) - SwipeRefreshLayout.this.mCircleView.getTop());
    ...
    void moveToStart(float interpolatedTime) {
        setTargetOffsetTopAndBottom((this.mFrom + ((int) ((this.mOriginalOffsetTop - this.mFrom) * interpolatedTime))) - this.mCircleView.getTop());
    }
