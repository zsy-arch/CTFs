        ...
        if (startValues != null && endValues != null && startValues.values.containsKey(PROPNAME_CLIP) && endValues.values.containsKey(PROPNAME_CLIP)) {
            ...
            if (!(start == null && end == null)) {
                ...
                if (!start.equals(end)) {
                    ...
                    animator = ObjectAnimator.ofObject(endValues.view, (Property<View, V>) ViewUtils.CLIP_BOUNDS, (TypeEvaluator) new RectEvaluator(new Rect()), (Object[]) new Rect[]{start, end});
                    if (endIsNull) {
