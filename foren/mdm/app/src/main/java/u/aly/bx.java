...
public final class bx {
    ...
    private static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            if (obj instanceof List) {
                return bx.a((List) obj, (List) obj2);
            }
            if (obj instanceof Set) {
                return bx.a((Set) obj, (Set) obj2);
            }
            if (obj instanceof Map) {
                return bx.a((Map) obj, (Map) obj2);
            }
            if (obj instanceof byte[]) {
                return bx.a((byte[]) obj, (byte[]) obj2);
            }
            return bx.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static String a(byte b) {
        return Integer.toHexString((b | dc.a) & 511).toUpperCase().substring(1);
    }
