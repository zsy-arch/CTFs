...
public class e {
    ...
    public static String d(String str) {
        ...
        int i = 0;
        while (true) {
            String[][] strArr = f1445a;
            if (i >= strArr.length) {
                str2 = "*/*";
                break;
            } else if (a2.equalsIgnoreCase(strArr[i][0])) {
                str2 = f1445a[i][1];
                break;
            } else {
                i++;
