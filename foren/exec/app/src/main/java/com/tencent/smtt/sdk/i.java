...
public class i extends ServiceWorkerController {
    ...
    public ServiceWorkerWebSettings getServiceWorkerWebSettings() {
        ...
        return new ServiceWorkerWebSettings() { // from class: com.tencent.smtt.sdk.i.1
    ...
    public void setServiceWorkerClient(final ServiceWorkerClient serviceWorkerClient) {
        if (Build.VERSION.SDK_INT >= 24) {
            ServiceWorkerController.getInstance().setServiceWorkerClient(new android.webkit.ServiceWorkerClient() { // from class: com.tencent.smtt.sdk.i.2
