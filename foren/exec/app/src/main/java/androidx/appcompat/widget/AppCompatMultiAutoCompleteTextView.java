...
public class AppCompatMultiAutoCompleteTextView extends MultiAutoCompleteTextView implements l {
    ...
    public static final int[] f112a = {16843126};

    /* renamed from: b  reason: collision with root package name */
    public final C0047o f113b;
    ...
    public AppCompatMultiAutoCompleteTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        ha.a(context);
        ka a2 = ka.a(getContext(), attributeSet, f112a, i, 0);
        if (a2.f(0)) {
            setDropDownBackgroundDrawable(a2.b(0));
        }
        a2.f605b.recycle();
        this.f113b = new C0047o(this);
        this.f113b.a(attributeSet, i);
        this.f114c = new A(this);
        this.f114c.a(attributeSet, i);
        this.f114c.a();
    }
}
